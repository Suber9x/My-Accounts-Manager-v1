	      ...
	      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
	        <ul class="navbar-nav mr-auto">
	          ...
	          <li class="nav-item dropdown">
	            ...
	            <div class="dropdown-menu" aria-labelledby="dropdown01">
	              ...
	              <a class="dropdown-item" href="change.php">Change Account Password</a>
	            </div>
	          </li>
	        </ul>
	        <form class="form-inline my-2 my-lg-0">
	          <p><?php 
	          	if($permission == 2){
					?>
						<p style="color: rgba(255,255,255,.5)" class=" mr-sm-2 ">Hello <?php echo $user->data()->name; ?>, <a href="#"><?php echo escape($user->data()->username) ?></a></p>
